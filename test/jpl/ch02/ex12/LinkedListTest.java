...
public class LinkedListTest {
	...
	public void testSetNextLinkedListArray() {
		...
		assertThat(Deencapsulation.getField(item1, "next"), nullValue());

		item1.setNext(item2, item3);

		assertThat(Deencapsulation.getField(item1, "next"), is(item2));
		assertThat(Deencapsulation.getField(item2, "next"), is(item3));
	}
