...
public class DigitalClock extends JWindow {
	...
	public DigitalClock() {
		...
		menu.addSeparator();
		menu.add(new JMenuItem("Close")).addActionListener(new ActionListener() {
			@Override
		...
		addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
				...
				DigitalClock.this.setLocation(eventLocationOnScreen.x - startPos.x,
						eventLocationOnScreen.y - startPos.y);
			}
		});
	}
